...
source_count: 39
summary: Agent harnesses are the non-model execution layer that assembles context, runs tools, enforces policy, brokers credentials, emits correlated telemetry, persists artifacts, and turns agent loops into deployable AI systems.
