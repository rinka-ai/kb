...
- representation learning tasks where a downstream model or search index needs useful geometry rather than raw symbols
...
- the same vector geometry that makes paraphrase retrieval easy can make exact evidence recovery harder when the task needs a literal witness
