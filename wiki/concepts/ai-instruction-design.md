...
source_count: 6
summary: AI instruction design turns always-on assistant prompts into scoped, testable behavioral contracts for truthfulness, evidence handling, uncertainty, tone, tool use, and context discipline, whose lifecycle and regressions remain inspectable instead of trusting one successful completion.
