...
- Turn recurring frontend quality expectations into a complete operating loop: local script, CI gate, PR checklist, repo instruction, and retrievable convention page.
