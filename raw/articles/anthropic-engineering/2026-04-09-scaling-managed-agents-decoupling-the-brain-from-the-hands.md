...
- Anthropic reports that this decoupled architecture dropped p50 TTFT by roughly 60% and p95 by more than 90%.
...
- The conclusion frames Managed Agents as a “meta-harness”: opinionated about stable interfaces around Claude, but not opinionated about which harness, sandbox, or component implementation future agents require.
