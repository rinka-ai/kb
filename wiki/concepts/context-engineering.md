...
source_count: 26
summary: Context engineering is the discipline of deciding what information enters active model context, in what form, and with what update policy, including which behavioral instructions deserve always-on placement and how domain task distributions decide context tiers.
canonical_for: [context engineering, context compression, task distribution compression, vertical agent context hierarchy]
...
- Allocate context by task-distribution frequency and error cost: L1 for always-used wrappers, L2 for one-step curated specs, and L3 for complete raw references plus bounded search skills.
