...
This index groups official documentation added to strengthen the KB's coverage of runtime architecture, protocol surfaces, memory operations, and secure payment-side effects.
