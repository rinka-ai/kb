...
source_count: 23
summary: Agent harnesses are the non-model execution layer that assembles context, runs tools, enforces policy, persists artifacts, and turns agent loops into deployable AI systems.
