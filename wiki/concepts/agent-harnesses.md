...
- shape common-domain observations and mutation reports so the model sees compressed semantics, consequences, and likely errors instead of raw API dumps
