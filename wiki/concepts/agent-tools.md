...
source_count: 25
summary: Agent tools are structured action surfaces for non-deterministic systems; they require precise schemas, tighter ergonomics, abstention tests, stateful and end-state evaluation, credential boundaries, zero-trust authorization, and stronger orchestration than human-only APIs.
